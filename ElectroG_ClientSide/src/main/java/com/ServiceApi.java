...
public class ServiceApi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = appObj.insertService(request.getParameter("topic"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = appObj.updateService(param.get("hidApp_IDSave").toString(),
				param.get("topic").toString().toString().replace("+", " "),     
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = appObj.deleteService(param.get("app_ID").toString());
